			...
			<div class="buttons">
			  <div class="row">
				...
				<input type="button" name="b0" value="0" onClick="calcNumbers(b0.value)">
				  ...
				  <input type="button" name="mudu" value="%" onClick="calcNumbers(mudu.value)">
				</div>
                <div class="row">
                      <input type = "button" name="Clear" value="c" onclick ="form.displayResult.value= ' '" >
                      <input type="button" name="cancel" value="ce" onClick="calcNumbers(cancel.value)">
                      <input type="button" name="exit" value="X" onClick="calcNumbers(exit.value)">
