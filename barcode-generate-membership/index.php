...
?>
<title>MEMBERSHIP ID CARD PRINT</title>
<style>
img.barcode {
...
<div class="container">
	<h2>Print Your Membership Id Card</h2>	
	<br>
	<br>
	<div class="row">	
		<div class="col-md-4">
			<form method="post">
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label>Membership id Card Name</label>
							...
							<?php
                                    ...
                                    {  
                                    ?>
									 <option value="<?php echo $row_book['membership_id']; ?>"><?php echo $row_book['member_name']; ?></option>
									<?php
									} 
									?>
							</select>
				...
				<div class="row">
					<div class="col-md-7">
						...
						<input type="submit" name="generateBarcode" class="btn btn-primary form-control" value="Generate Membership Id">
					</div>
				</div>
			</form>
		</div>
		<div class="col-md-4">
		 <?php
			if(isset($_POST['generateBarcode'])) {
				...
				if($barcodeText != '') {
					echo '<h4>Barcode:</h4>';
					echo '<img class="barcode" alt="'.$barcodeText.'" src="index.php?text='.$barcodeText.'&codetype='.$barcodeType.'&orientation='.$barcodeDisplay.'&size='.$barcodeSize.'&print='.$printText.'"/>';
				} else {
